...
<form method="post" action="">
            ...
            <div class="panel-heading">
              <h2><input type="text" name="title" placeholder="Blog Title" class="form-control" required></h2>
            </div>

            <div class="panel-body penplate">
              <textarea rows="20" cols="100" name="body" class="form-control" required></textarea>           
              <div class="form-group"><br/>
                    <input type="submit" class="form-control btn-primary" value="Post Blog">
                </div>
                <hr>
            </div>
          </div>
